...
public class CreateServiceItemRequestValidator : AbstractValidator<CreateServiceItemRequest>
{
    public CreateServiceItemRequestValidator()
    {
        RuleFor(x => x.Title)
        ...
        RuleForEach(x => x.Options).SetValidator(new CreateServiceItemOptionValidator());
    }
}

public class CreateServiceItemOptionValidator : AbstractValidator<CreateServiceItemOptionRequest>
{
    public CreateServiceItemOptionValidator()
    {
        RuleFor(x => x.Title)
