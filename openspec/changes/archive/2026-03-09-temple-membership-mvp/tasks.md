...
- [x] 4.1 撰寫 AuthService 單元測試（註冊、登入、Token 刷新、忘記密碼、重設密碼）
- [x] 4.2 撰寫 MemberService 單元測試（Profile CRUD、列表搜尋、角色變更、狀態變更）
- [x] 4.3 執行所有測試並確認通過
...
- [x] 7.1 前後端聯調測試（完整流程：註冊→登入→Profile→後台管理）
- [x] 7.2 建立 README.md（啟動步驟、環境需求、設定說明）
